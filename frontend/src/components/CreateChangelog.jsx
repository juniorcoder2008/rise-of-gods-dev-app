  ...
  return (
    <div className='ml-10 mt-10'>
      ...
      <form className='flex flex-col gap-3' onSubmit={createNewChangelog}>
        <input type="text" className='input' placeholder='Version (z.B. 0.4.2)' ref={version} required />
        <textarea maxLength={2000} className='text-area resize-none' placeholder='Changelogs' ref={content} required ></textarea>
